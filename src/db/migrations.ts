import type { KahanyakuDb } from "./client.js";

interface Migration {
  id: number;
  name: string;
  up(db: KahanyakuDb): void;
}
...
const MIGRATIONS: Migration[] = [
  ...
  },
  {
    ...
    up(db) {
      ...
      // able to break `kahanyaku init` entirely just because full-text search isn't
...
export function runMigrations(db: KahanyakuDb): void {
  db.exec(`
